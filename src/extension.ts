...
export let cloudProvider: CloudDataProvider;
...
export async function activate(context: vscode.ExtensionContext) {
  ...
  cloudProvider = new CloudDataProvider(context.secrets);
  ...
  context.subscriptions.push(
    ...
    vscode.window.registerTreeDataProvider("dbos-ttdbg.views.resources", cloudProvider),
